...
import {
  Text, View, StyleSheet, ScrollView, SafeAreaView, TextInput, Pressable, FlatList, Dimensions, Image, Button, ImageBackground,
} from "react-native";
...
export default function News({ props, navigation }) {
  ...
  >
    ...
    <ImageBackground source={item.image} style={styles.cardImage}>
      ...
      <Text style={styles.overlayText}>Tin tức</Text>
        ...
        Cập nhật giá chung cư VinHome Central Park mới nhất</Text>
      </View>
  ...
  const house =[
    { id: 1, image: require("../../image/vinhome.jpg") ,
  ...
  return (
    ...
    <ScrollView>
        ...
        Những thông tin mới nhất,hấp dẫn nhất về thị trường bất động sản Việt Nam</Text>
        <FlatList
          data={house}
  ...
  <View style={styles.bottomImageContainer}>
    <Image source={require("../../image/interior2.jpg")} style={styles.bottomImage} />
    ...
    <View style={styles.bottomImageTextContainer}>
      <Text style={{ fontSize: 16,
         color: COLORS.tittleColor
          }}>06/04/2023 10:30</Text>
      <Text style={styles.bottomImageText}>Tại sao căn hộ 2 PN lại chiếm ưu thế lớn</Text>
      <Text style={{
         fontSize: 12, 
         paddingHorizontal: 10, 
         marginLeft: 22, 
         marginRight: 22 }}>
        Khách hàng có điều kiện tài chính thường sẽ hướng đến căn hộ 2 phòng ngủ ngay từ đầu bởi đây là lựa chọn tối ưu cho nhiều gia đình.
      </Text>
    </View>
  </View>
  <View style={{  
