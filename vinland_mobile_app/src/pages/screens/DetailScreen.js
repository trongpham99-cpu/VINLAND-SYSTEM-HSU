...
return(
  <SafeAreaView style={{flex: 1, backgroundColor: COLORS.white}}>
        ...
        <Text style={{fontWeight: 'bold', fontSize: 20}}>Thông tin bất động sản</Text>
        <View style={styles.headerBtn}>
           <Image
    ...
    <View style={styles.iconfavorite}> 
        ...
        <Icon name="place" size={18} color={COLORS.blue} />
            <Text
              style={{color: COLORS.tittleColor, fontWeight: 'bold', fontSize: 15}}>
           Bình Trưng Tây,Quận2
            </Text>
            <View>
        <View style={{flexDirection: 'row',}}>
        ...
        <Text style={{marginTop: 10, fontWeight: 'bold', fontSize: 20,paddingBottom:10}}>
         Description
        </Text>
        <Text 
